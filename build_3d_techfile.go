...
func main() {
	...
	LayerStack := []Layer{ 	{ "Substrate", 	"Substrate", 0, 0, "#FFFFFF", -10.0, 10.0, 0},
							...
							{ "Cont", 		"Cont",      1, 0, "#00FF00", 0.32, 0.64,  0},
							{ "Metal1", 	"Metal1",    2, 0, "#0000FF", 0.0, 0.0,    1},
							{ "Via1", 		"Via1",      3, 0, "#FFFF00", 0.0, 0.0,    0},
							{ "Metal2", 	"Metal2",    4, 0, "#00FFFF", 0.0, 0.0,    1},
							{ "Via2", 		"Via2",      5, 0, "#FF00FF", 0.0, 0.0,    0},
							{ "Metal3", 	"Metal3",    6, 0, "#FF0000", 0.0, 0.0,    1},
							{ "Via3", 		"Via3",      7, 0, "#00FF00", 0.0, 0.0,    0},
							{ "Metal4", 	"Metal4",    8, 0, "#0000FF", 0.0, 0.0,    1},
							{ "Via4", 		"Via4",      9, 0, "#FFFF00", 0.0, 0.0,    0},
							{ "Metal5", 	"Metal5",   10, 0, "#00FFFF", 0.0, 0.0,    1},
							{ "TopVia1", 	"TopVia1",  11, 0, "#FF00FF", 0.0, 0.0,    0},
							{ "TopMetal1",  "TopMetal1",12, 0, "#FF0000", 0.0, 2.0,    1},
							{ "TopVia2", 	"TopVia2",  13, 0, "#00FF00", 0.0, 0.0,    0},
							{ "TopMetal2",  "TopMetal2",14, 0, "#0000FF", 0.0, 3.0,    1},
							{ "MIM", 		"MIM",		10, 0, "#00FFFF", 5.3, 0.150,  0},
    }						
...
func writeTechFileHeader(file *os.File) {
	...
	file.WriteString("# Date    : 10 Aug 2024 \n")
	file.WriteString("# \n")
...
func writeLayer(file *os.File, layer Layer) {
	...
	file.WriteString("Layer: " + strconv.Itoa(layer.GDSNumber) + "\n")
	...
	// #RRGGBB
	// hex 0x00-0xff to decimal 0.0-1.0 
	// 0x00 = 0.0, 0xff = 1.0
	// convert to float
